...
class GUI():
    def __init__(self,master):
        ...
        root.config(bg='#63B0CD')
        root.resizable(False, False)

        self.label = Label(text=":PASSWORD GENERATOR:", anchor=N, fg='#39393A', bg='#63B0CD', font='arial 20 bold underline')
        ...
        self.user = Label(text="Enter User Name: ", font='times 15 bold', bg='#63B0CD', fg='#68228B')
        ...
        self.length = Label(text="Enter Password Length: ", font='times 15 bold', bg='#63B0CD', fg='#68228B')
        ...
        self.generated_password = Label(text="Generated Password: ", font='times 15 bold', bg='#63B0CD', fg='#68228B')
        ...
        self.accept = Button(text="ACCEPT", bd=3, relief='solid', padx=1, pady=1, font='Helvetica 15 bold italic', fg='#000000', bg='#00FF00', command=self.accept_fields)
        self.accept.grid(row=13, column=1)

        self.blank_label1 = Label(text="")
        self.blank_label1.grid(row=14, column=1)

        self.reset = Button(text="RESET", bd=3, relief='solid', padx=1, pady=1, font='Helvetica 15 bold italic', fg='#000000', bg='#FF0000', command=self.reset_fields)
